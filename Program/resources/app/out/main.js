...
module.exports = function (e) {
    ...
    "use strict";
    var i = t(24), r = t(68), o = Object.prototype.toString;
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(2), r = t(62), o = t(14), s = t(5).default(i.join(__rootDir, "../bin/ThunderHelper.node"));
    !function (e) {
    ...
    "use strict";
    var i = t(3), r = t(70), o = {"Content-Type": "application/x-www-form-urlencoded"};
    ...
    var a, l = {
        adapter: ("undefined" != typeof XMLHttpRequest ? a = t(71) : "undefined" != typeof process && (a = t(28)), a),
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(4), r = t(10), o = t(11), s = t(15), a = t(59);
    !function (e) {
        let n;
        !function (e) {
    ...
    "use strict";
    var i = t(3), r = t(25), o = t(27), s = t(29), a = t(30), l = t(31).http, d = t(31).https, c = t(32), u = t(85),
        f = t(86), h = t(19), p = t(26);
    ...
    var i = t(32), r = t(29), o = t(30), s = t(76), a = t(77).Writable, l = t(78)("follow-redirects"),
    ...
    (n = e.exports = i.debug = i.default = i).coerce = function (e) {
        ...
        return !1
    }, n.humanize = t(80), n.instances = [], n.names = [], n.skips = [], n.formatters = {}
}, function (e, n, t) {
    "use strict";
    e.exports = function (e) {
    ...
    const o = t(0), s = t(12), a = t(1), l = t(6), d = t(9), c = t(46), u = t(2), f = t(5), h = t(47), p = t(16),
        m = t(48), g = t(49), w = t(50), v = t(51), C = t(52), b = t(54), y = t(13), _ = t(55), T = t(60), S = t(94);
    ...
    let N = null, x = !0, E = null, W = R.getTickCount(), D = c.HistoryDataNS.getMainWndSizeHistoryData(), P = !1,
        I = !0, O = 1020, F = 1020, L = 650, A = global;

    function U() {
        if (null !== E) {
            let e = E.getBounds(), n = e.x + Math.round((e.width - F) / 2), t = e.y + Math.round((e.height - L) / 2);
            E.setBounds({x: n, y: t, width: F, height: L})
        }
    }
    ...
    A.mainRendererWindow = null, A.silentMainWnd = !1, A.silentSupsWnd = !1, function () {
        for (let e = 0; e < process.argv.length; e++) "--autotest:startup" === process.argv[e] ? P = !0 : "-StartType:Install" === process.argv[e] ? (D.exitState = "normal", D.width = O, D.height = 650) : "-silent" === process.argv[e] ? A.silentMainWnd = !0 : "-nofloatwnd" === process.argv[e] && (A.silentSupsWnd = !0)
    }(), o.ipcMain.on("closeMainWindow", (e, n) => i(this, void 0, void 0, function* () {
        if (null !== E) if ("BossKey" === n) if (E.isVisible()) {
            V("BossKey", "BossKeyState", !0);
            let e = b.SuspensionWindowHelper.getSuspensionWindow();
            e && e.hide(), E.minimize(), E.hide(), N.destroy()
        } else V("BossKey", "BossKeyState", !1), E.isMinimized() && E.restore(), E.show(), q(), G("ConfigFloatPanel", "FloatPanelValue", "0").then(e => {
        }).catch(); else E.minimize(), E.hide()
    })), o.ipcMain.on("maximizeMainWindow", () => {
        B()
    }), o.ipcMain.on("restoreMainWindow", () => {
        null !== E && ("max" === D.exitState && !0 === I ? (I = !1, U()) : (I = !1, E.restore()))
    ...
    o.ipcMain.on(l.ThunderChannelList.channelRMProcessSend, (e, n) => {
        ...
        for (let e = j.length - 1; e >= 0; --e) try {
            process.kill(j[e], 0)
        } catch (e) {
            c.HistoryDataNS.setExitType("normal"), o.app.quit()
        }
    }, 1e3);
    const z = "development" === process.env.RUN_ENV ? "http://localhost:9080/main-renderer/" : `file:///${__dirname}/main-renderer/index.html`,
        H = `${__rootDir}/out/common-preload.js`;
    ...
    function q() {
        M.information(`${__rootDir}/static/thunderx.ico`), null !== (N = new o.Tray(`${__rootDir}/static/thunderx.ico`)) && (M.information("settooltip"), N.setToolTip("迅雷"), N.on("click", () => {
            ...
            null !== b.SuspensionWindowHelper.getSuspensionWindow() && r.splice(3, 0, {
                type: "submenu",
                label: "悬浮窗显示设置",
                submenu: [{
    ...
    o.app.on("ready", () => {
        r.PerformanceMonitorStatNS.trackColdStartUpEvent("ready_of_app_in_main").catch(), function () {
            let e = D.width, n = D.height;
            (O = o.screen.getPrimaryDisplay().size.width) <= 1024 ? (O = 356, e = 356) : O = 356, E = new o.BrowserWindow({
                width: e,
                height: n,
                minWidth: O,
                minHeight: 316,
                ...
                show: !1,
                backgroundColor: "#FFF",
                webPreferences: {devTools: !0, preload: H, webSecurity: !1}
            }), C.loginUIObj.init(E, R), m.default(E, R), T.NewTaskDlgsManagerNS.init(E, R), g.default(E, R), w.default(), v.default(E, R), A.mainRendererWindow = E, E.loadURL(z), R.initGDIPlus(), E.on("ready-to-show", () => {
                T.NewTaskDlgsManagerNS.setReady(!0), r.PerformanceMonitorStatNS.trackColdStartUpEvent("ready_to_show_of_mainwindow_in_main").catch(), "max" === D.exitState && B();
                let e = o.nativeImage.createFromPath(`${__rootDir}/static/thunderx.ico`);
                E.setIcon(e), q(), M.information("endThunderStartProcess"), R.endThunderStartProcess(), c.HistoryDataNS.setExitType("");
                let n = "areo=0";
                R.isDwmCompositionEnabled() && (n = "areo=1"), R.isDropShadowEnabled() ? n += ",shadow=1" : n += ",shadow=0", d.XLStatNS.trackEvent("core_event", "system_setting", "", 0, 0, 0, 0, n), P && s.writeFile("autoteststartup.txt", new Date, e => {
                    e && M.information(e)
                }), setTimeout(() => i(this, void 0, void 0, function* () {
                    yield K(), setInterval(() => i(this, void 0, void 0, function* () {
                        yield K()
                    }), 6e5)
                }), 5e3), A.silentMainWnd ? (E.minimize(), E.hide()) : (E.isMinimized() && E.restore(), E.show(), p.ToolsUtilitiesAWNS.setForegroundWindow(R, E)), setTimeout(() => {
                    b.SuspensionWindowHelper.createSuspensionWindow(R), R.initLiveUD()
                }, 2e3)
            }), E.on("close", e => {
                let n = c.HistoryDataNS.getExitType();
                M.information("close:exitType = ", n), "normal" !== n && (null !== E && (E.minimize(), E.hide()), e.preventDefault())
            }), E.on("show", () => {
                A.silentMainWnd = !1, A.silentSupsWnd = !1
            }), E.on("unmaximize", () => {
                "max" === D.exitState && !0 === I && (I = !1, U())
        ...
        x = n;
        let t = b.SuspensionWindowHelper.getSuspensionWindow();
        t && t.webContents.send("can-start-all-task", n)
    ...
    n.default = function () {
        i.ipcMain.on("dropdown-file-window-create", (e, n, t) => {
            do {
                ...
                let a = new i.BrowserWindow({frame: !1, resizable: !1, parent: e, show: !1, width: 400, height: s});
                o[n] = a, a.on("ready-to-show", () => {
                    a.webContents.send("dropdown-file-window-created", t)
                }), e.on("close", () => {
                    r.information("parent close"), a.close()
                }), a.on("close", () => {
                }), a.on("closed", () => {
                    delete o[n]
                }), a.on("blur", () => {
            ...
            do {
                ...
                if (o.hasOwnProperty(String(n))) {
                    ...
                    if (!d) break;
                    let c = i.screen.getCursorScreenPoint(), u = i.screen.getDisplayNearestPoint(c).workAreaSize.height,
                        f = e.getBounds(), h = l.getSize(), p = f.y + d.bottom;
                    r.information("show dropdown", p, h[1], u), p + h[1] > u && (p = f.y + d.top - h[1]);
                    let m = a(Math.floor(h[1]));
                    l.setBounds({
                        x: Math.floor(f.x + d.left),
                        y: Math.floor(p),
                        width: Math.floor(d.width),
                        height: m
                    }), r.information("show dropdown setBounds", m), l.show(), l.focus()
    ...
    n.loginUIObj = new class {
        ...
        init(e, n) {
            ...
            }), i.ipcMain.on("create-personal-info-window", (e, n, t, i) => {
                let r = this.createPersonalInfoWnd(n, t, i);
                e.sender.isDestroyed() || e.sender.send("personal-info-window-created", r.id)
            })
        }
        ...
        createPersonalInfoWnd(e, n, t) {
            ...
            (s.x < 0 || s.y < 0) && (s.width >= a[0] && s.height >= a[1] ? (s.x = s.x + Math.round((s.width - a[0]) / 2), s.y = s.y + Math.round((s.height - a[1]) / 2) - 1) : (s.x = -1, s.y = -1)), u.information("updatePersonalInfoWnd:", s, a, e);
            ...
            return i.ipcMain.once("personal-info-init", t => {
                ...
                d.default(l, this.thunderHelperObj, this.parentWnd)
            }), l.on("closed", () => {
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(0), r = t(6), o = t(7);
    let s = null;
    const a = "development" === process.env.RUN_ENV ? "http://localhost:9080/suspension-renderer/" : `file:///${__dirname}/suspension-renderer/index.html`,
        l = `${__rootDir}/out/common-preload.js`;
    !function (e) {
        e.createSuspensionWindow = function (e) {
            (s = new i.BrowserWindow({
                frame: !1,
                height: 260,
                width: 394,
                skipTaskbar: !0,
                ...
                x: -999,
                y: -999,
                webPreferences: {preload: l}
            })).loadURL(a), s.on("ready-to-show", () => {
                o.default(s, e)
            }), s.on("show", () => {
                s.webContents.send(r.ThunderChannelList.channelMRSuspensionWindowShowOrHide, !0)
            }), s.on("hide", () => {
                s.webContents.send(r.ThunderChannelList.channelMRSuspensionWindowShowOrHide, !1)
            })
        }, e.getSuspensionWindow = function () {
            return s
        }
    }(n.SuspensionWindowHelper || (n.SuspensionWindowHelper = {}))
}, function (e, n, t) {
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(56), r = t(57);
    ...
    (function () {
        return i(this, void 0, void 0, function* () {
            if ("renderer" === process.type) {
                ...
                const e = yield Promise.resolve().then(() => t(58)), n = yield Promise.resolve().then(() => t(23));
    ...
    Object.defineProperty(n, "__esModule", {value: !0});
    const r = t(0), o = t(9), s = t(1), a = t(22), l = t(6), d = t(7), c = t(61), u = t(16), f = t(63),
    ...
    Object.defineProperty(n, "__esModule", {value: !0});
    const r = t(2), o = t(5), s = t(1), a = t(0), l = t(6), d = t(13), c = t(14), u = t(17), f = t(64),
    ...
    "use strict";
    Object.defineProperty(n, "__esModule", {value: !0});
    const i = t(2), r = t(1), o = t(14), s = t(65), a = t(17), l = t(5), d = r.default.getLogger("ThunderNewTask"),
    ...
    "use strict";
    var i = t(3), r = t(24), o = t(69), s = t(18);
    ...
    }, l.Cancel = t(35), l.CancelToken = t(92), l.isCancel = t(34), l.all = function (e) {
        return Promise.all(e)
    }, l.spread = t(93), e.exports = l, e.exports.default = l
}, function (e, n) {
    function t(e) {
 ...
 */
    ...
    "use strict";
    var i = t(18), r = t(3), o = t(87), s = t(88);
    ...
    "use strict";
    var i = t(3), r = t(25), o = t(27), s = t(72), a = t(73), l = t(19),
        d = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || t(74);
    e.exports = function (e) {
    ...
    "undefined" == typeof process || "renderer" === process.type ? e.exports = t(79) : e.exports = t(81)
}, function (e, n, t) {
    function i() {
        var e;
        try {
    ...
    "use strict";
    const i = t(8), r = t(84), o = process.env;
    let s;
    ...
    "use strict";
    var i = t(3), r = t(89), o = t(34), s = t(18), a = t(90), l = t(91);
